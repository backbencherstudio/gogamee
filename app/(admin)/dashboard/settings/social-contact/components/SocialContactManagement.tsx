...
import { getSocialContactLinks, updateSocialContactLinks, type SocialContactLinks } from '../../../../../../services/settingsService'
...
export default function SocialContactManagement() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success) {
        addToast({ type: 'success', title: 'Social media and contact links updated successfully' })
        await loadData()
      } else {
    ...
    return (
      <div className="pt-4 min-h-screen mb-4 p-4">
        <div className="flex justify-center items-center py-12">
          <div className="text-gray-600 text-lg font-medium">Loading social contact links...</div>
        </div>
      </div>
    )
  }
